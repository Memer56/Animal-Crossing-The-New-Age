...
@export var bunny_dialogue : Array = [
	[["Hello, I'm [color=blue]<Insert fucking name>[/color], who are you?"], "Bunny", [], null]
]
@export var cat_dialogue : Array = [
	[["Why hello there! I'm a [color=purple]CAT[/color]! You don't look like a cat", "I do need a potato...", "Can I take [color=blue]100,000[/color] bells?"], "Cat", [], null]
]
...
func get_correct_dialogue(npc_name : String, dialogue_index : int) -> Array:
	...
	match npc_name:
		...
		"Tommy":
			pass
		"Bunny":
			dialogue_array = bunny_dialogue[dialogue_index]
		"Cat":
			dialogue_array = cat_dialogue[dialogue_index]
